# build-path [![Build status for build-path](https://img.shields.io/circleci/project/sholladay/build-path/master.svg "Build Status")](https://circleci.com/gh/sholladay/build-path "Builds")
